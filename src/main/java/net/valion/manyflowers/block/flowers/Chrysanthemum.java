...
public class Chrysanthemum extends FlowerBlock implements ManyFlowersBiomeTexturedBlockInterface, FactoryBlock {
    ...
    public Chrysanthemum(RegistryEntry<StatusEffect> stewEffect, float effectLengthInSeconds, Settings settings) {
        ...
        Registry.register(Registries.ITEM, Identifier.of(ManyFlowers.MOD_ID, "block/chrysanthemum"), item);
    }
