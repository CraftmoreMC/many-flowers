...
public class ManyFlowersModeledBlockItem extends BlockItem implements AutoModeledPolymerItem {
    private final Item item;
    public ManyFlowersModeledBlockItem(Block block, Settings settings, Item item) {
